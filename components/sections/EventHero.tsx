    ...
    <>
      ...
      <div className="hidden lg:flex overflow-hidden pt-5 pb-8">
        ...
        <div
          ...
          style={{
            maxWidth: '900px',
            WebkitMaskImage: 'radial-gradient(ellipse 78% 90% at 63% 50%, black 45%, transparent 78%)',
            maskImage: 'radial-gradient(ellipse 78% 90% at 63% 50%, black 45%, transparent 78%)',
          }}
        >
          <Image
            src={event.image}
