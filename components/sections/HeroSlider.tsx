    ...
    <section className="lg:pt-5 pb-8">
      ...
      >
        ...
        <div
          ...
          style={{
            WebkitMaskImage: 'radial-gradient(ellipse 75% 90% at 72% 50%, black 45%, transparent 78%)',
            maskImage: 'radial-gradient(ellipse 75% 90% at 72% 50%, black 45%, transparent 78%)',
          }}
        >
          {imageStack('62vw')}
        </div>
