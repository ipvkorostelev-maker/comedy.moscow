      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
          ...
          <div className="flex items-center gap-3">
            <a href="https://vk.com/lb_events_team" target="_blank" rel="noopener noreferrer" aria-label="ВКонтакте" className="w-8 h-8 flex items-center justify-center rounded-lg bg-white/5 border border-white/8 text-cream/40 hover:text-cream/80 hover:bg-white/8 transition-all">
            ...
            <a href="https://t.me/lb_events" target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="w-8 h-8 flex items-center justify-center rounded-lg bg-white/5 border border-white/8 text-cream/40 hover:text-cream/80 hover:bg-white/8 transition-all">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
